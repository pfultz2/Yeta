...
{
    struct true_type
    : yeta::integral_constant<bool, true>
    {};
    static_assert(true_type(), "Failed");
    struct false_type
    : yeta::integral_constant<bool, false>
    {};
    static_assert(!false_type(), "Failed");

    typedef yeta::integral_constant<int, 1> one_type;
    typedef yeta::integral_constant<int, 2> two_type;
